...
import OgYouT4x from "../assets/images/4x-Images/ogYouT4x.png";
...
export const Contact = () => {
  ...
  const ServiceHourItem = ({ Icon, title, content }) => (
    <div
      className={`flex items-center p-4 rounded-xl mb-3 shadow-md bg-white ${inkText}`}
    >
  ...
  return (
    <div className="bg-base text-ink min-h-screen">
      ...
      <section className="relative min-h-[500px] text-white py-16 md:py-24 contact-header-bg overflow-hidden">
        ...
        <div
          className="absolute inset-0 z-5 duration-300"
          style={{ backgroundColor: darkOverlayColor, opacity: 0.5 }}
        ></div>
        ...
        <div className="mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl relative z-10">
          <div className="text-left max-w-5xl">
            ...
            <p className="text-lg md:text-xl font-light mb-0 leading-relaxed opacity-90">
              ...
              about our services, or want to speak with our team, LTI’s support
              is available
            </p>
          </div>
        </div>
      ...
      <div className="py-20" style={{ backgroundColor: lightAccentBg }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2
            className={`text-4xl font-extrabold mb-16 text-center ${inkText}`}
          >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2">
              ...
              <div className="bg-white p-8 rounded-3xl shadow-2xl h-full">
                <h3 className={`text-3xl font-bold mb-8 ${inkText}`}>
                ...
                <div className="mt-8 p-6 rounded-2xl border-l-8 border-brand/70 bg-gray-50 shadow-inner">
                  <div className="flex items-center mb-3">
                    ...
                    <h4 className={`font-extrabold text-xl ${inkText}`}>
                      Multilingual support
                    </h4>
                  </div>
                  <p className="text-gray-600">
                    English, Arabic, Spanish, Chinese, Portuguese, French &
                    Russian
                  </p>
                </div>
              </div>
            ...
            <div className="lg:col-span-1 space-y-6">
              ...
              <div
                className={`bg-white rounded-3xl p-6 shadow-elegant hover:shadow-glow transition-transform transform hover:-translate-y-1 flex flex-col ${inkText}`}
              >
                ...
                <div className="mt-4 pt-4 border-t border-gray-100">
                  ...
                  <a
                    href="mailto:support@londontradingindex.com "
                    className={`font-bold hover:${brandAccent}`}
                  >
                  ...
                  <a
                    href="mailto:Compliance@londontradingindex.com"
                    className={`font-bold hover:${brandAccent}`}
                  >
                  ...
                  <a
                    href="mailto:partnerships@londontradingindex.com"
                    className={`font-bold hover:${brandAccent}`}
                  >
              ...
              >
                ...
                <p className="text-sm font-medium">
                  ...
                  directly from your{" "}
                  <a href="#" className="font-bold hover:text-brand">
                    Client Portal
                  </a>{" "}
                  or{" "}
                  <a href="#" className="font-bold hover:text-brand">
      ...
      <section
        className={`py-16 px-4 sm:px-6 lg:px-8 ${primaryDarkBg} text-white`}
      >
            ...
            {[
              {
                ...
                name: "LinkedIn",
                color: "#0076b2",
                link: "https://www.linkedin.com/company/london-trading-index/",
              },
              {
                Icon: OgTw4x,
                name: "Twitter/X",
                color: "#000000",
                link: "https://x.com/ldntradingindex?s=21",
              },
              {
                Icon: OgInsta4x,
                name: "Instagram",
                color: "#ff6440",
                link: "https://www.instagram.com/londontradingindex/profilecard",
              },
              {
                Icon: OgYouT4x,
                name: "YouTube",
                color: "#ff0033",
                link: "https://www.youtube.com/@londontradingindex5068",
              },
            ].map(({ Icon, name, color, link }) => (
              <a key={name} href={link} className="group">
                <div
                  className="bg-white rounded-3xl p-6 flex flex-col items-center justify-center
