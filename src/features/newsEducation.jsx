              ...
              <CardHeader>
                <div className="flex items-center space-x-4">
                  <div className="w-12 h-12 gradient-primary rounded-lg flex items-center justify-center">
                    <Newspaper className="h-6 w-10 text-primary-foreground" />
                  </div>
                  <div>
                    <CardTitle className="sm:text-2xl text-foreground font-bold">
        ...
        */}
              ...
              <CardContent>
                <div className="mb-12">
                  ...
                  <p className="text-center text-gray-600 max-w-3xl mx-auto mb-12 leading-relaxed text-lg">
                    LTI’s multilingual education library is designed to help you
                    gain deep expertise in both financial markets and our
                    trading platforms. Whether you’re building a solid
                    foundation or enhancing advanced strategies, our resources
                    are available anytime through the client portal.
                  </p>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    {educationFormats.map((format, index) => (
                      ...
                      >
                        ...
                        <h5
                          className={`font-manrope font-extrabold text-[18px] sm:text-[20px] mb-3 relative z-10 ${format.textColor}`}
                        >
                          {format.title}
                        </h5>
                        ...
                        <div
                          className={`${format.textColor} font-manrope font-semibold text-[13px] sm:text-[14px] relative z-10`}
                        >
                          {format.duration}
                        </div>
                      </motion.div>
          ...
          >
            <div className="relative z-10">
              ...
              <h5
                className={`font-manrope font-extrabold text-[18px] sm:text-[20px] mb-3 relative z-10 text-white`}
              >
                Stay informed. Stay Ahead.
              </h5>
              <blockquote className="text-xl md:text-2xl font-bold text-primary-foreground mb-6 leading-relaxed">
                "The trader that prepares, is the trader that survives. With
                LTI, you’re equipped with both the insight and the education to
          ...
          >
            <p className="text-xs text-muted-foreground max-w-4xl mx-auto leading-relaxed">
              The content provided through LTI’s platforms - including market
              news, economic calendars, videos, audio, and educational materials
              - is intended solely for general informational and educational
              purposes. It does not constitute investment advice, a
              recommendation, or a solicitation to buy or sell any financial
              instruments. All trading involves risk. Information published on
              this page, within the Client Portal, or via our trading platforms
              is not tailored to your personal financial circumstances or
              investment objectives. Users should exercise their own judgement
              and seek independent financial advice where necessary. Access to
              these materials is subject to our Terms & Conditions, and Risk
              Disclosure. Market commentary and third-party content made
              available through MT5 or the LTI Portal are provided “as is” and
              are not guaranteed for accuracy, completeness, or timeliness.
              Where applicable, educational resources may be considered
              marketing communication under relevant laws and are not intended
              to constitute regulated research.
            </p>
          </motion.div>
        </motion.div>
      </div>
