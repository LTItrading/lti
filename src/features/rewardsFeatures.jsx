...
const RewardsFeatures = () => {
  ...
  const tradingTools = [
    ...
    },
    {
      ...
      title: "Custom Alerts",
      description:
        "Set price-based or indicator-triggered alerts across platforms.",
      bgcolor:
    ...
    },
    {
      ...
      description:
        "Download hundreds of scripts, indicators, and automated strategies",
      bgcolor: "bg-[rgba(238,66,35,1)] text-white",
      textColor: "text-white",
    },
    {
                ...
                <div className="grid md:grid-cols-2 gap-8 items-center">
                  <div>
                    <p className="text-muted-foreground mb-6 text-lg leading-relaxed">
                      LTI’s trading contests will give you the chance to test
                      your skills, showcase your strategy, and win real rewards
                      - all in a fair and competitive environment.
                    </p>
          ...
          >
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                Whether you're analysing trades, testing strategies, or
                executing with precision - our platform and client area come
                equipped with advanced tools designed to enhance your trading
                intelligence.
              </p>
            </div>
